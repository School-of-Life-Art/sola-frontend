    ...
    return (
        <View className="w-full h-full">
            <ImageBackground className=" w-full h-auto flex-1" source={require("./assets/images/loginBg.png")}>
                <StatusBar hidden />
                <View className="mt-auto bg-gray-100 h-5/6 rounded-t-3xl">
                    <ScrollView>
                        ...
                        <View className="w-full h-full px-5 py-5 ">
                            ...
                            <KeyboardAvoidingView className="">
                                ...
                                <TextInput
                                    placeholder="age"
                                    className="mb-3 border border-gray-400 rounded-full px-6 py-2 text-lg text-gray-500 font-semibold"
                                // value={inputText}
                                // onChangeText={handleInputChange}
                                />
                                <TextInput
                                ...
                                <TextInput
                                    ...
                                    className="mt-3 border border-gray-400 rounded-full px-6 py-2 text-lg text-gray-500 font-semibold"
                                    secureTextEntry
                                // value={inputText}
                                // onChangeText={handleInputChange}
                                />
                                ...
                                <View className="flex flex-col justify-between items-center gap-3 mb-5">
                                    <Text className="text-lg text-gray-600 ">Already have an account? <Text className="underline underline-offset-4 text-blue-600 ">Sign Up</Text></Text>
                                    <Text className="text-lg text-gray-600 ">Read our <Text className="underline underline-offset-4 text-blue-600 ">Terms & Conditions</Text></Text>
                                </View>
